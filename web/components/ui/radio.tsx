...
const base = [
  ...
  // Focus ring
  "group-data-[focus]:outline group-data-[focus]:outline-2 group-data-[focus]:outline-offset-2 group-data-[focus]:outline-orange-500",
  // Disabled state
...
export function Radio({
  ...
  return (
    <Headless.Radio
      data-slot="control"
      {...props}
      className={cx(className, "group inline-flex focus:outline-none")}
    >
