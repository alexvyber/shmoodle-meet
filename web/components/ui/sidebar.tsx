...
export function Sidebar({ className, ...props }: React.ComponentPropsWithoutRef<"nav">) {
  return (
    <nav
      {...props}
      className={cx(className, "flex h-full min-h-0 flex-col")}
    />
  )
}
...
export function SidebarDivider({ className, ...props }: React.ComponentPropsWithoutRef<"hr">) {
  return (
    <hr
      {...props}
      className={cx(className, "my-4 border-t border-zinc-950/5 lg:-mx-4 dark:border-white/5")}
    />
  )
}
...
export function SidebarSpacer({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  return (
    <div
      aria-hidden="true"
      {...props}
      className={cx(className, "mt-8 flex-1")}
    />
  )
}
...
export function SidebarHeading({ className, ...props }: React.ComponentPropsWithoutRef<"h3">) {
  return (
    <h3
      {...props}
      className={cx(className, "mb-1 px-2 text-xs/6 font-medium text-zinc-500 dark:text-zinc-400")}
    />
  )
}
