...
const colors = {
  ...
  blue: "bg-orange-500/15 text-orange-700 group-data-[hover]:bg-orange-500/25 dark:text-orange-400 dark:group-data-[hover]:bg-orange-500/25",
  indigo:
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  const classes = cx(
    className,
    "group relative inline-flex rounded-md focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-orange-500"
  )
