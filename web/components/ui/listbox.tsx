    ...
    >
      <Headless.ListboxButton
        ...
        className={cx([
          ...
          "focus:outline-none",
          // Focus ring
          "after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:data-[focus]:ring-2 after:data-[focus]:ring-orange-500",
          // Disabled state
        ...
        return (
          <div
            className={cx(
              ...
              // Focus
              "outline-none data-[focus]:bg-orange-500 data-[focus]:text-white",
              // Forced colors mode
